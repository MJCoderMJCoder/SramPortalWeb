...
<body
	onload="queriesCourseUpdate('<%=basePath%>queriesCourse', '<option value=${grade.gradeCourse.courseId }>${grade.gradeCourse.courseName }</option>')">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="45%" align="right" valign="middle"><input
								...
								onclick="verifyGradeUpdate('submit')"></td>
