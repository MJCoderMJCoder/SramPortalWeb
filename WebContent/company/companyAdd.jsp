					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td align="left" valign="middle"><font color="red"
								id="companyNameHint" size="1">*公司简介标题不能为空</font></td>
						</tr>
						<tr>
							<td colspan="2" align="right" valign="middle"><label
							...
							<td align="left" valign="middle"><font color="red"
								id="companyImageHint" size="1">*公司简介图片不能为空（图片格式：jpg、png、gif）</font></td>
						</tr>
						<tr>
							<td colspan="2" align="right" valign="middle"><br>公司简介详情<br></td>
