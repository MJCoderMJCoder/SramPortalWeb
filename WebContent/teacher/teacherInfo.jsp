...
<body
	...
	onmousemove="hasSession('${teacher.id}', '<%=basePath%>backstage')">
	<table width="100%" border="0">
		<tr>
			<td width="10%" valign="top">
				...
				<dl>
					<dt
						...
						<h3>
							<img id="teacherImg" src="<%=basePath%>teacher/images/unfold.jpg"
			...
			<td align="center" valign="top"><form
					action="<%=basePath%>modifiedTeacher" method="post"
