...
<body>
	...
	<table class="banner" width="100%" background="images/bannerBg.jpg">
		<tr>
			...
			<td align="center" valign="middle" nowrap="nowrap"><a
				href="<%=basePath%>queriesTeacher" target="_self"><span
					style="color: blue; background-color: white;">师资力量</span></a></td>
			<td align="center" valign="middle" nowrap="nowrap"><a
		...
		<tr>
			<td align="center" valign="middle"><table width="90%" border="0"
							...
							<c:choose>
								<c:when test="${(temp%4) == 0 }">
									<td align="left" valign="bottom"><div class="personDiv">
											<img src="<%=basePath%>teacherImages/${teacher.image}"
												alt="照片" width="220" height="250" /> <br /> <br /> 教师姓名：
											${teacher.name }<br /> <br /> 毕业院校： ${teacher.school }<br />
											<br /> <span
												style="overflow: auto; height: 22px; display: inline-block;">
												工作经历： ${teacher.teacherExperience }</span><br />
					...
					<tr>
						...
						<c:otherwise>
							<td align="left" valign="bottom"><div class="personDiv">
									<img src="<%=basePath%>teacherImages/${teacher.image}" alt="照片"
										width="220" height="250" /> <br /> <br /> 教师姓名：
									${teacher.name }<br /> <br /> 毕业院校： ${teacher.school }<br />
									<br /> <span
										style="overflow: auto; height: 22px; display: inline-block;">
										工作经历： ${teacher.teacherExperience }</span><br />
